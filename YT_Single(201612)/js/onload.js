(function ($) {
    ...
    var Book_v7 = {
        ...
        autoMarginB: function () {
            return Math.round($('#fb7').height() * 0.015)
        },
        ...
        autoMarginL: function () {
            return Math.round($('#fb7').width() * 0.015)
        },
        ...
        all_pages: function () {
            ...
            $('#fb7-slider li').on('click', function () {
                ...
                setTimeout(function () {
                    setPage(tmp);
                    $('#dy li').each(function () {
                        if ($(this).attr('dyid') == tmp) {
                            $('#magazine').turn('page', $(this).text())
        ...
        book_grab: function () {
            ...
            $('.content-frame').find(".content-body").css('cursor', '-webkit-grab');
            $('.content-frame').find(".content-body").css('cursor', '-moz-grab');
        },
        ...
        book_grabbing: function () {
            ...
            $('.content-frame').find(".content-body").css('cursor', '-webkit-grabbing');
            $('.content-frame').find(".content-body").css('cursor', '-moz-grabbing');
        },
        ...
        drag: function (e) {
            ...
            $('.content-frame').find(".content-body").unbind('mousemove');
            $('.content-frame').find(".content-body").bind('mousemove', Book_v7.book_grabbing);
        ...
        drop: function () {
            ...
            $('.content-frame').find(".content-body").bind('mousemove', Book_v7.book_grab);
            $('.content-frame').find(".content-body").removeClass('draggable');
        },
        ...
        dragdrop_init: function () {
            ...
            if (higherThanWindow == false) {
                ...
                $('.content-frame').find(".content-body").unbind('mousedown', Book_v7.drag);
                $('.content-frame').find(".content-body").unbind('mouseup', Book_v7.drop);
                $('.content-frame').find(".content-body").unbind('mousemove', Book_v7.book_grab);
                $('.content-frame').find(".content-body").unbind('mousemove', Book_v7.book_grabbing);
                $('.content-frame').find(".content-body").css('cursor', 'default');
            } else {
                //mobile
                ...
                $('.content-frame').find(".content-body").bind('mousedown', Book_v7.drag);
                $('.content-frame').find(".content-body").bind('mouseup', Book_v7.drop);
                $('.content-frame').find(".content-body").bind('mousemove', Book_v7.book_grab);
                Book_v7.book_grab();
            }
            Book_v7.resize_page();
    ...
    var Navigation_v7 = {
        ...
        init: function () {
            ...
            //full screen
            $('.fb7-fullscreen').on('click', function (e) {
            ...
            $('.fb7-zoom-in').on('click', function () {
                ...
                $('.fb7-nav-arrow').css('display', 'block !important')
                $('#fb7-container-book').css('display', 'none');
                $('#magazine').css('display', 'block');
                $('#dym').css('display', 'block');

                tb();
                if ($('#magazine').turn('page') != 1 && $('#magazine').turn('page') != $('#dy li:last').text()) {
                    $('.bottomjt').css('display', 'block');
                    $('.topjt').css('display', 'block')
                } else if ($('#magazine').turn('page') == 1) {
                    $('.bottomjt').css('display', 'none');
                } else if ($('#magazine').turn('page') == $('#dy li:last').text()) {
                    $('.topjt').css('display', 'none')
            ...
            $('.fb7-zoom-out').on('click', function () {
                ...
                $('#fb7-container-book').css('display', 'block')
